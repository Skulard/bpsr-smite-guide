...
Always lead with one of those before casting Infusion (channeled DPS barrage, made uninterruptible by factors)
...
The Stag Charge is a special upgrade to Wild Bloom, the first Ability, when achieving 10 stacks of Bloom.
When cast it will instantly refresh Infusion with an upgrade to it, which causes it to do double damage. [...]
```
